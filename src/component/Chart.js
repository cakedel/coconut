  ...
  return (
    <section className="Chart">
      <div className="inner">
        ...
        <ul className="TabMenu">
          {LISTTITLE.map((tit, idx) => {
            return (
              <li
                key={tit.id}
                onClick={() => setListState(tit.id)}
                className={listState === tit.id ? "on" : ""}
              >
                {tit.tit}
              </li>
            );
        ...
        <div className="inbox">
          <ul className={`SingList TodayList ${listState === 1 ? "on" : ""}`}>
                  ...
                  <figure className="album">
                    <img
                      src={
                        ...
                        "/assets/img/album" +
                        (idx > 8 ? list.id + ".jpg" : "0" + list.id + ".jpg")
                      }
                    />
                  </figure>
                  <Link to="/">
                    <figure className="des">
          ...
          <ul
            key={GLOBALLIST.id}
            className={`SingList GlobalList ${listState === 2 ? "on" : ""}`}
          >
          ...
          <ul
            key={BILLBOARDLIST.id}
            className={`SingList Billboard ${listState === 3 ? "on" : ""}`}
          >
